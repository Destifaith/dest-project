...
const equipmentTypes = ["Cardio Machines", "Weight Training", "Free Weights", "Functional Training", "Yoga Studio"];
const gymTypes = ["Fitness Center", "CrossFit", "Boutique Gym", "24/7 Gym"];
const facilitiesList = ["Lockers", "Showers", "Personal Trainers", "Group Classes", "Sauna", "Smoothie Bar", "Parking"];
...
const AddGym = () => {
  ...
  useEffect(() => {
    ...
    daysOfWeek.forEach(day => {
      initialHours[day] = { open: false, from: "06:00", to: "22:00" };
    });
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    data.append("gym_type", formData.gym_type);
    ...
    router.post("/gyms", data, {
      onSuccess: () => {
        ...
        router.visit("/dashboard/entertainment/gym/manage");
      },
    ...
    <DashboardLayout>
      <LoadScript googleMapsApiKey={import.meta.env.VITE_GOOGLE_MAPS_API_KEY} libraries={libraries}>
        <div className="px-4 lg:px-6">
          <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Add Gym</h1>
          <p className="mt-2 text-gray-700 dark:text-gray-300">Fill in the details below to add a new gym.</p>
          ...
          <form className="mt-6 space-y-4" onSubmit={handleSubmit}>
            ...
            {/* Gym Name */}
            <div>
              <label className="block font-medium text-gray-700 dark:text-gray-200">Gym Name *</label>
              <input
                type="text"
                name="name"
                required
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block font-medium text-gray-700 dark:text-gray-200">Equipment Type *</label>
                <select
                  name="equipment_type"
                  required
              ...
              <div>
                <label className="block font-medium text-gray-700 dark:text-gray-200">Gym Type *</label>
                <select
                  name="gym_type"
                  required
                ...
                {errors.gym_type && <p className="text-red-500 text-sm mt-1">{errors.gym_type}</p>}
              </div>
            </div>
                      ...
                      <div className="flex items-center space-x-2">
                        <div className="flex items-center">
                          ...
                          <input
                            type="time"
                            id={`from-${day}`}
                            value={formData.opening_hours[day]?.from || "06:00"}
                        ...
                        <div className="flex items-center">
                          ...
                          <input
                            type="time"
                            id={`to-${day}`}
                            value={formData.opening_hours[day]?.to || "22:00"}
