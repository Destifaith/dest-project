...
const SwimmingPools = () => {
 ...
 const handleSubmit = (e: React.FormEvent) => {
  ...
  if (!formData.main_image) {
    newErrors.main_image = "Please select a main image.";
  }
  ...
  // Update the route to match your API endpoint
  router.post("/swimming-pools", data, {
    onSuccess: () => {
      setFormData({
        location: "",
        name: "",
      ...
      setErrors({});
      setSuccessMessage("Swimming pool added successfully!");
      // Clear previews
      if (mainImagePreview) {
        URL.revokeObjectURL(mainImagePreview);
        setMainImagePreview(null);
      ...
      router.visit('/dashboard/entertainment/pool/manage');
    },
    ...
    <DashboardLayout>
      <LoadScript googleMapsApiKey={import.meta.env.VITE_GOOGLE_MAPS_API_KEY} libraries={libraries}>
        <div className="px-4 lg:px-6">
          <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Add Swimming Pool</h1>
          <p className="mt-2 text-gray-700 dark:text-gray-300">Fill in the details below to add a new swimming pool.</p>
          ...
          <form className="mt-6 space-y-4" onSubmit={handleSubmit}>
            ...
            {/* Gallery Images - Updated with Add More functionality */}
            <div>
